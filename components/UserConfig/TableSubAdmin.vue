    ...
    <v-data-table :headers="headers" :items="user_details" item-key="sub_admin_id" v-model="selected" select-All class="elevation-1">
		...
		<template v-slot:items="props">
			<tr :active="props.selected" @click="props.selected = !props.selected">
				...
				<td>{{ props.item.sub_admin_fname + ' ' + props.item.sub_admin_surname}}</td>
				<td>{{ props.item.sub_admin_dob }}</td>
				<td>{{ props.item.sub_admin_email }}</td>
				<td>{{ props.item.sub_admin_contact }}</td>
				<td>{{ props.item.sub_admin_centre_name }}</td>
				<td>{{ props.item.sub_admin_address_state }}</td>
